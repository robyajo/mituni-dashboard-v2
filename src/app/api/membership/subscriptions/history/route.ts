...
export async function POST(request: Request) {
  try {
    ...
    let apiUrl = `${process.env.NEXT_PUBLIC_API_URL}/api/memberships/subscriptions/history`;

    console.log(
      `[Subscriptions History API Proxy] Forwarding to backend URL: ${apiUrl}`,
    );
    ...
    if (contentType.includes("multipart/form-data")) {
      ...
      console.log(`[Subscriptions History API Proxy] Rebuilding FormData:`);
